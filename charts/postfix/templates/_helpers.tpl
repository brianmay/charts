...
{{/*
Generate certificates for smtp server
*/}}
{{- define "postfix.gen-certs" -}}
{{- $altNames := list ( .Values.postfix.hostname ) }}
{{- $ca := genCA "postfix-ca" 365 -}}
{{- $cert := genSignedCert .Values.postfix.hostname nil $altNames 365 $ca -}}
